...
reportes_compute_colors <- function() {
    ...
    allowed_colors_df <- data.frame(
        color_name = names(allowed_bs4Dash_colors),
        color_value = allowed_bs4Dash_colors |> purrr::map_chr(~.x) |> unname()
    )
    ...
    color_data <- purrr::map2(ncolors, names, ~{
        ...
        purrr::reduce(rbind) |> 
        rbind(allowed_colors_df)
    
    # remove duplicate color_values
    color_data <- color_data |> 
        split(~color_value) |> 
        purrr::map(~.x[1,]) |>
        purrr::reduce(rbind)
    
    # arrange by color_name    
    color_data <- color_data[order(color_data$color_name), ]
...
reportes_bs_colors <- function() {
    ...
    list(`accent-1` = "#7FC97F", `accent-2` = "#BEAED4", `accent-3` = "#FDC086", 
         ...
         `accent-7` = "#BF5B17", `accent-8` = "#666666", black = "#111111", 
         blue = "#007BFF", cyan = "#17A2B8", `dark2-1` = "#1B9E77", 
         `dark2-2` = "#D95F02", `dark2-3` = "#7570B3", `dark2-4` = "#E7298A", 
         `dark2-5` = "#66A61E", `dark2-6` = "#E6AB02", `dark2-7` = "#A6761D", 
         fuchsia = "#FF9CE9", green = "#28A745", lightblue = "#B9E0F7", 
         maroon = "#FB8BB4", navy = "#8DA4BD", olive = "#C9EB8F", 
         orange = "#FFCF99", `paired-1` = "#A6CEE3", `paired-10` = "#6A3D9A", 
         `paired-12` = "#B15928", `paired-2` = "#1F78B4", `paired-3` = "#B2DF8A", 
         `paired-4` = "#33A02C", `paired-5` = "#FB9A99", `paired-6` = "#E31A1C", 
         `paired-7` = "#FDBF6F", `paired-8` = "#FF7F00", `paired-9` = "#CAB2D6", 
         `pastel1-1` = "#FBB4AE", `pastel1-2` = "#B3CDE3", `pastel1-3` = "#CCEBC5", 
         `pastel1-4` = "#DECBE4", `pastel1-5` = "#FED9A6", `pastel1-6` = "#FFFFCC", 
         `pastel1-7` = "#E5D8BD", `pastel1-8` = "#FDDAEC", `pastel1-9` = "#F2F2F2", 
         `pastel2-1` = "#B3E2CD", `pastel2-2` = "#FDCDAC", `pastel2-3` = "#CBD5E8", 
         `pastel2-4` = "#F4CAE4", `pastel2-5` = "#E6F5C9", `pastel2-6` = "#FFF2AE", 
         `pastel2-7` = "#F1E2CC", `pastel2-8` = "#CCCCCC", purple = "#D095D1", 
         red = "#DC3545", `set1-1` = "#E41A1C", `set1-2` = "#377EB8", 
         `set1-3` = "#4DAF4A", `set1-4` = "#984EA3", `set1-6` = "#FFFF33", 
         ...
         `set3-10` = "#BC80BD", `set3-12` = "#FFED6F", `set3-2` = "#FFFFB3", 
         `set3-3` = "#BEBADA", `set3-4` = "#FB8072", `set3-5` = "#80B1D3", 
         `set3-6` = "#FDB462", `set3-7` = "#B3DE69", `set3-8` = "#FCCDE5", 
         `set3-9` = "#D9D9D9", white = "#FFFFFF", yellow = "#FFC107")
}
